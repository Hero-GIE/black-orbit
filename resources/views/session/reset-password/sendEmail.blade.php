                    ...
                    <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                        <div class="card card-plain mt-8">
                            <div class="card-header pb-0 text-center bg-transparent">
                                ...
                                <h3 class="font-weight-bolder" style="color: #2F3DF0; font-size: 1.6rem;">Forgot Password</h3>
                                <p class="mb-0" style="font-size: 14px;">Enter your email to reset your password</p>
                            </div>
                            <div class="card-body">
                                @if($errors->any())
